...
const getOrders = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield order_model_1.default.find().populate('user', 'name').populate('restaurant', 'name');
});
exports.getOrders = getOrders;
const getOrderById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield order_model_1.default.findById(id).populate('user', 'name').populate('restaurant', 'name');
});
